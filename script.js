// UPDATED Movie Data - Only up to ID 8 with new movies
const allMovies = [
    // ID 1: The Big Fake - 2026, Dual Audio (Not Hall Print)
    {
        id: 1,
        title: "The Big Fake",
    ...
    // ID 2: People We Meet on Vacation - 2026, Dual Audio (Not Hall Print)
    {
        id: 2,
    ...
    // ID 3: Tiffin Box - 2026, Bangla (Not Hall Print)
    {
        id: 3,
        title: "Tiffin Box",
    ...
    // ID 4: Kirtaner Por Kirtan - 2026, Bangla (Not Hall Print)
    {
        id: 4,
    ...
    // ID 5: Wonder Man [S1] - 2026, Dual Audio (Not Hall Print)
    {
        id: 5,
        title: "Wonder Man [S1]",
    ...
    // ID 6: O'Romeo - 2026, Hindi (Hall Print)
    {
        id: 6,
        title: "O'Romeo",
    ...
    // ID 7: Made in Korea (2026) - Hindi Dubbed (Not Hall Print)
    {
        id: 7,
    ...
    // ID 8: Funky - 2026, Hindi Dubbed (Not Hall Print)
    {
        id: 8,
        title: "Funky",
