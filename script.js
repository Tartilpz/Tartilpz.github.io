// UPDATED Movie Data - First two movies replaced with your new 2026 releases
const allMovies = [
    // NEW MOVIE 1: The Big Fake - 2026, Dual Audio
    {
        id: 1,
        title: "The Big Fake",
    ...
    // NEW MOVIE 2: People We Meet on Vacation - 2026, Dual Audio
    {
        id: 2,
    ...
    // The rest of your existing movies (unchanged, but shifted IDs)
    {
        id: 3,
        title: "Tiffin Box",
    ...
    },
    {
        id: 9,
        title: "Demon Slayer",
        poster: "https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        category: "Anime",
        year: 2023,
        isNew: true,
        downloads: [
    ...
    },
    {
        id: 10,
        title: "RRR",
        poster: "https://images.unsplash.com/photo-1489599809516-9827b6d1cf13?ixlib=rb-4.0.3&auto=format&fit=crop&w=1074&q=80",
    ...
    },
    {
        id: 11,
        title: "John Wick 4",
        poster: "https://images.unsplash.com/photo-1595769812725-4c6564f7528b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        category: "English",
        year: 2023,
        isNew: true,
        downloads: [
    ...
    },
    {
        id: 13,
        title: "One Piece: Red",
        poster: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        category: "Anime",
        year: 2022,
        isNew: true,
        downloads: [
    ...
    },
    {
        id: 14,
        title: "Pushpa 2",
        poster: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1120&q=80",
        category: "South Indian",
        year: 2024,
        isNew: true,
        downloads: [
    ...
    },
    {
        id: 15,
        title: "Fast X",
        poster: "https://images.unsplash.com/photo-1531259683007-016a7b628fc3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1074&q=80",
        category: "English",
        year: 2023,
        isNew: true,
        downloads: [
    ...
    },
    {
        id: 16,
        title: "KGF Chapter 2",
        poster: "https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80",
        category: "South Indian",
        year: 2022,
        isNew: false,
        downloads: [
...
// Form validation elements - UPDATED: categoryError removed
...
// Function to create movie card HTML - Now includes year
...
// Function to filter movies by category - UPDATED: Removed South Indian and Korean logic
...
function toggleOnlyNew() {
    ...
    if (onlyNewActive) {
        ...
        currentMovies = allMovies.filter(movie => movie.isNew);
    } else {
...
// Function to open movie modal - Now shows only 1080p
...
// Function to validate request form - UPDATED: Category validation removed
...
// Function to handle movie request - UPDATED: Category parameter removed
...
// Request Movie form submission - UPDATED: Category field removed
