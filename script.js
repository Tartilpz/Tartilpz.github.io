...
const allMovies = [
    {
        ...
        poster: "https://image.tmdb.org/t/p/w300/fTfLd3s9yBNOzbFHD2aXvwEs93H.jpg",
        category: "English",
        year: 2026,
        isNew: true,
        isHallPrint: false,
        ...
        downloads: [
            { 
                quality: "720p", 
                episode: "Episode 1",
                url: "https://mcloud.guru/523d27fca0e2003"
            },
            { 
                quality: "720p", 
                episode: "Episode 2",
                url: "https://mcloud.guru/6c2c9b846010728"
            },
            { 
                quality: "720p", 
                episode: "Episode 3",
                url: "https://mcloud.guru/e881c13d85158f5"
            },
            { 
                quality: "720p", 
                episode: "Episode 4",
                url: "https://mcloud.guru/62cd285a8c68f05"
            }
        ]
    },
    {
        ...
        poster: "https://i.imgbd.org/poster_3t7i1774608387.png",
        category: "Dual Audio",
        year: 2026,
        isNew: true,
        isHallPrint: false,
        contentType: "movie",
        downloads: [
            { quality: "1080p", url: "https://mcloud.guru/36f1cc99b745a65" }
        ]
    },
    {
        id: 17,
        title: "Louis Theroux: Inside the Manosphere",
        poster: "https://image.tmdb.org/t/p/w300/ouOvRvsgF37yEx3D6ZLWyuxZFjE.jpg",
        category: "Dual Audio",
        year: 2026,
        isNew: true,
        isHallPrint: false,
        contentType: "movie",
        downloads: [
            { quality: "1080p", url: "https://mcloud.guru/7c42b74f235456b" }
        ]
    },
    {
        id: 16,
    ...
    {
        id: 6,
        title: "Young Sherlock [S1]",
        poster: "https://m.media-amazon.com/images/M/MV5BMGY1NGJkOTAtM2RmNC00NWI3LWJkY2EtYjU1YmY5OGFjN2RjXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg",
        category: "Dual Audio",
        year: 2026,
        isNew: true,
        isHallPrint: false,
        ...
        downloads: [
            { 
                ...
                url: "https://mcloud.guru/c0dda7e9d9e65e7"
            }
        ]
    },
    {
        ...
        downloads: [
            { 
                quality: "1080p", 
                episode: "Complete Season",
                url: "https://mcloud.guru/58b587d622a7418"
            }
        ]
    },
    {
...
function createMovieCard(movie) {
    ...
    const episodeInfo = movie.contentType === 'series' && movie.totalEpisodes 
        ? `<div class="episode-count">${movie.totalEpisodes} Episodes</div>` 
        : '';
        ...
        if (movie.contentType === 'series') {
            ...
            movie.downloads.forEach((download, index) => {
                ...
                downloadOption.innerHTML = `
                    <h4>${episodeText}</h4>
                    <p>Quality: ${download.quality} | Format: MP4</p>
